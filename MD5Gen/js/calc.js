function C5() {
  ...
  if (
    ...
    var a =
      "This function only works on the recent version of Firefox, Chrome and Opera. ";
...
function iF3(a) {
  ...
  document.getElementById("file_size_label").textContent =
    commafy(file.size) + " Bytes";
  b2_ = 1024 * 1024;
  nvx = file.size;
  var c = nvx % b2_;
  g0P(c, nvx);
...
function c_P() {
  ...
  if (d == c) {
    document.getElementById("compare_ico").className =
      "IcoSprite IcoCorrect IcoPos";
  } else {
    document.getElementById("compare_ico").className =
      "IcoSprite IcoError IcoPos";
  }
}
function v3X_() {
